...
app.config["SIMPLELOGIN_USERNAME"] = "Jurandir"
app.config["SIMPLELOGIN_PASSWORD"] = "Bar1982"
db = SQLAlchemy()
db.init_app(app)
SimpleLogin(app)
...
def cadastrar_produto():
    if request.method == "POST":
        ...
        try:
            ...
            status = {"type": "erro", "message": f"Houve um problema em cadastrar o produto {dados['nome']}!"}
